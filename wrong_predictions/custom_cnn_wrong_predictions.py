...
from custom_cnn_momento import CustomCNN  # Importe sua classe CustomCNN

# Caminho para o arquivo do modelo treinado
model_path = 'models-trained/cnn_model_config1.pth'
...
input_channels = 3  # Número de canais de entrada (RGB)

print("Configurando o modelo...")
# Carregar o modelo Custom CNN
...
report_file = 'custom_cnn_relatorio_previsoes_erradas.csv'
